<div class="nav-tabs-custom">
      ...
      <a class="waves-effect waves-light btn" href="<?php echo site_url() ?>employees/add" role ="tab">Add Employee</a>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php $j=0;
                            ...
                            <tr class="<?php echo $style; ?> gradeX">
                                ...
                                <td class="center"><a class="waves-effect waves-light btn" href="<?php echo site_url()."employees/edit/".$_emp['user_id']; ?>"><i class="tiny material-icons">mode_edit</i></a> | <a class="waves-effect waves-light btn" href="<?php echo site_url()."employees/delete/".$_emp['user_id']; ?>" onClick="return confirm('Are you sure you want to remove this employee <?php echo $_emp['employeeid']; ?>')"><i class="tiny material-icons">delete</i></a></td>
                            </tr>
                            <?php }} ?>
