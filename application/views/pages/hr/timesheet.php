<div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li style = "font-weight: bold;" class="active"><a href="" role="tab">Timesheet</a></li>

                    <li ><a href="<?php echo site_url() ?>time/attendance" role="tab">Attendance</a></li>
      ...
      <a class="waves-effect waves-light btn" href="<?php echo site_url() ?>employees/add" role ="tab">Add Timesheet</a>
...
<div class="row">
    ...
    <div class="col-lg-12">
          ...
          <div class = "panel-heading"><h5>Manage Timesheet</h5></div> 
