<div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                 ...
                 <li style = "font-weight: bold;"><a href="<?php echo site_url() ?>loan" role="tab">Loan</a></li>
                  ...
                  <li style = "font-weight: bold;"  class="active"><a href="#" role="tab">Shift</a></li>
      ...
      <a class="waves-effect waves-light btn" href="#" role ="tab">Add Shift</a>
...
<div class="row">
    ...
    <div class="col-lg-12">
          ...
          <div class = "panel-heading"><h5>Manage Employees Shift</h5></div> 
                <div class="divider"></div>
                <br><br>
